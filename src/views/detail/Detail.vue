...
export default {
  ...
  methods: {
    ...
    contentScroll(position) {
      ...
      // [0, 6807, 7791, 8045]
      // 0 < positionY < 6807, index = 0
      // 6807 <= positionY < 7791, index = 1
      // 7791 <= positionY < 8045, index = 2
      // positionY >= 8045, index = 3
  ...
  created() {
    ...
    getDetail(this.iid).then((res) => {
      ...
      this.$nextTick(() => {
        ...
        // 但是图片依旧没有加载完成(目前获取的offsettop不包含图片)
        this.themeTopYs = [];
